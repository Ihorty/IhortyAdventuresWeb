<?php
    ...
    /** Hay que dejar descomentado una de las conexiones, si no, va a ir muy lenta la carga de la página */
    ...
    $conexion = mysqli_connect("ragoria.com","IhortyReader","R34d3r@PotatoDatabase","ragoria", "3307"); 
